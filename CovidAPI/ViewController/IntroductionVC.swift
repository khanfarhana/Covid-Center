...
class IntroductionVC: UIViewController {
    ...
    let quotes = ["A big Thank You to all the Frontliners for helping everyone get through this pandemic 👩🏻‍⚕️.","Nothing lasts forever. Not even the coronavirus. So stay home, stay safe and fight hard🏡.","Clean your hands. Protect your health 🧤.","wear a mask, spread joy not germs 😷.","Social distance doesn't mean, We aren't together🧍🏻‍♀️←→🧍🏻.","When diet is wrong, medicine is of no use. When diet is correct, medicine is of no need 🥗.","Stop touching your face to reduce your chances of catching coronavirus🧏🏻‍♀️.","Maintain your hygiene, not germs 🧴."]
